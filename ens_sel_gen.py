...
model_file = '%s/selector_ncar_gen_MSLP' % root_data_dir
result_file = '%s/result_ncar_gen_MSLP.nc' % root_data_dir
convolved = False
...
selector.fit_generator(generator, epochs=epochs, verbose=1, validation_data=(p_val, t_val), use_multiprocessing=True)
