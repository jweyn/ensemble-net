...
radar_root_dir = '/home/disk/wave2/jweyn/Data/NEXRAD'
radar_file = ['%s/%s.nc' % (radar_root_dir, d) for d in ['2015', '2016', '2017']]
radar_interp_file = '%s/2015-2017_28N40N100W78W.nc' % radar_root_dir
...
radar_interpolated = radar.interpolate(ensemble.lat[y1:y2, x1:x2], ensemble.lon[y1:y2, x1:x2], times=all_times,
                                       method='cubic', padding=3., output_file=radar_interp_file, verbose=True)
...
fss_ds.to_netcdf('extras/fss_2015-2017_28N40N100W78W.nc')
